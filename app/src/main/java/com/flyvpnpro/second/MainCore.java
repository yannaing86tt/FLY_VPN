...
{
	private static MainCore mInstance = null;
	private Context mContext;
	
	public static void init(Context context) {
		if (mInstance == null) {
			mInstance = new MainCore(context);
		}
	}
	
	private MainCore(Context context) {
		mContext = context;
    ...
    private void createNotificationChannels() {
        ...
        NotificationChannel mChannel = new NotificationChannel(MainService.NOTIFICATION_CHANNEL_BG_ID,
        ...
        mChannel = new NotificationChannel(MainService.NOTIFICATION_CHANNEL_NEWSTATUS_ID,
...
//        mChannel = new NotificationChannel(MainService.NOTIFICATION_CHANNEL_USERREQ_ID,
