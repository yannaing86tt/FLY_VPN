...
import com.flyvpnpro.second.util.FileUtils;
...
import com.flyvpnpro.second.util.securepreferences.crypto.Cryptor;
import com.flyvpnpro.second.util.securepreferences.model.SecurityConfig;
import java.util.ArrayList;
import com.flyvpnpro.second.util.Cripto;
...
public class ConfigParser
{
	...
	public static final String FILE_EXTENSAO = "fly";
    ...
    try {
      mConfigFile.storeToXML(tempOut, "Arquivo de Configuração");
    } catch (FileNotFoundException e) {
      throw new IOException("File Not Found");
    } catch (IOException e) {
