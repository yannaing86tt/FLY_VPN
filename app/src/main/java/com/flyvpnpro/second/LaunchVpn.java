...
{
	public static final String EXTRA_HIDELOG = "com.johnalvinja.javpnpro.showNoLogWindow";
	...
	private void showLogWindow() {
		Intent updateView = new Intent("com.flyvpnpro.main:openLogs");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == START_VPN_PROFILE) {
			...
			/*	else if (!prefs.getBoolean(Settings.PROXY_USAR_DEFAULT_PAYLOAD, true) && mConfig.getPrivString(Settings.CUSTOM_PAYLOAD_KEY).isEmpty()) {
        			...
        			startLW.setComponent(new ComponentName(this,"com.flyvpnpro.main.activities.ConfigGeralActivity"));
					...
					Toast.makeText(LaunchVpn.this, "Please Login First", 1).show();
