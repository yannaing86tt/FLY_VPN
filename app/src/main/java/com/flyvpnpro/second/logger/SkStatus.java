...
public class SkStatus
{
    ...
    private static ConnectionStatus getLevel(String state) {
        String[] noreplyet = {SSH_STARTING, SSH_CONNECTING, SSH_WAITING, SSH_RECONNECTING, "RESOLVE", "TCP_CONNECT"};
        String[] reply = {SSH_AUTHENTICATING, "GET_CONFIG", "ASSIGN_IP", "ADD_ROUTES", "AUTH_PENDING"};
        String[] connected = {SSH_CONNECTED};
        String[] notconnected = {SSH_DISCONNECTED};
