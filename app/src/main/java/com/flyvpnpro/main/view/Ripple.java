...
public class Ripple extends RelativeLayout{
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        /*CuboidButton cuboid =new CuboidButton(getContext());
        cuboid.setCr_icon(R.drawable.ic_cloud);
        LayoutParams cuboidParams = (LayoutParams) cuboid.getLayoutParams();
        float factor = getContext().getResources().getDisplayMetrics().density;
        cuboidParams.width = (int)(120 * factor);
        cuboidParams.height = (int)(120 * factor);
        addView(cuboid);*/
    }
    ...
    public Ripple setRippleColor(int color) {
        rippleColor = color;
        return this;
    }
