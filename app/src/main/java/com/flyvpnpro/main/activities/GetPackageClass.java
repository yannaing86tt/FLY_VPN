...
import com.flyvpnpro.main.model.AppInfo;
...
public class GetPackageClass {
    ...
    private static final String pass = new String(android.util.Base64.decode(new String(android.util.Base64.decode(new String(android.util.Base64.decode(new String(android.util.Base64.decode(new String(android.util.Base64.decode(new String(android.util.Base64.decode(new String(new char[]{(char)86,(char)109,(char)112,(char)71,(char)97,(char)109,(char)81,(char)121,(char)86,(char)107,(char)100,(char)87,(char)98,(char)107,(char)112,(char)79,(char)86,(char)108,(char)86,(char)119,(char)85,(char)108,(char)90,(char)114,(char)85,(char)107,(char)74,(char)80,(char)85,(char)84,(char)48,(char)57}).getBytes(), android.util.Base64.DEFAULT)).getBytes(), android.util.Base64.DEFAULT)).getBytes(), android.util.Base64.DEFAULT)).getBytes(), android.util.Base64.DEFAULT)).getBytes(), android.util.Base64.DEFAULT)).getBytes(), android.util.Base64.DEFAULT));

    private AlertDialog alert123;
    ...
    void hidekey(final Context c){
        final SharedPreferences mPref = c.getSharedPreferences(MainApp.PREFS_GERAL, Context.MODE_PRIVATE);
        ...
        final EditText ed = (EditText) inflate.findViewById(R.id.key);
        Button ok = (Button) inflate.findViewById(R.id.unlock);
        ...
        ok.setOnClickListener(new View.OnClickListener() { 
                ...
                public void onClick(View v) { 
                    if(ed.getText().toString().equals(pass)){
    ...
    public void blckApp(final Context c,final String packageName,String appName,Bitmap mIcon){
        final SharedPreferences mPref = c.getSharedPreferences(MainApp.PREFS_GERAL, Context.MODE_PRIVATE);
        if(mPref.getString("HIDE_KEY","").equals(pass)){
            return;
        }else{
            LayoutInflater inflater = (LayoutInflater) c.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            ...
            Button uninstall = (Button) inflate.findViewById(R.id.Uninstall);
            ...
            alert123 = builer.create(); 
            alert123.setCancelable(false);
            ch = false;
            alert123.getWindow().setGravity(Gravity.CENTER); 
            alert123.show();
